...
\projectinfo{
  ...
  title.cs={Registrace sekvence obrázků pro tvorbu HDR z několika expozic},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
  title.en={Image registration for HDR image acquisition from multiple exposures}, % název práce v angličtině / thesis title in english
  ...
  author.surname={Urgoš},   % příjmení autora / author surname 
